...
@section('content')
    ...
    <section class="relative h-72  flex flex-col justify-center align-center text-center space-y-4 mb-4">
        <div class="z-10">
            ...
            <div>
                <p class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-black hover:border-black">Start searching your lover</p>
            </div>
        </div>
    </section>
            ...
            @foreach($cards as $card)
                ...
                <div class="col-md-3 mb-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <img src="/storage/{{$card->profile_picture}}" class="card-img-top" alt="Doctor 1" width="300"
                             height="200">
                        <div class="card-body">
