...
<body
    style="background: linear-gradient(to left bottom, #ddabdc, #d0aae0, #c2a9e4, #b2a8e7, #a0a8e8, #8fadea, #7db1ea, #6db5e8, #62bde4, #60c4dc, #69c9d3, #78cec9);">
    <div class="container-fluid bar">
        <nav class="navbar  fixed-top navbar-fixed-top shadow-sm navbar-expand-lg py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse px-lg-3" id="navbarSupportedContent"
                style="font-weight: 600; font-size: large;">
                <div class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <div class="d-flex align-items-center ms-auto mb-2 mb-lg-0 ">
                        <div class="  me-2"><a href="{{ route('homefeed.show') }}"
                                class="nav-item nav-link active">Home</a></div>
                        <div class=" me-2"> <a href="{{ route('profile.show') }}"
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSttyb3Xqxti1vWn6sFQXO0nFKi0QtEn-1HWQ&usqp=CAU/300x200"
                                class="card-img-top" alt="Doctor 1" width="300" height="200">
                            <div class="card-body">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                        <h5>About Mayalu</h5>
                        <p class="text-muted">Mayalu is a dating website that helps people find their perfect match.
                        </p>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                        <h5>Links</h5>
